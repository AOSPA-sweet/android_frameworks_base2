...
open class QSTileViewImpl @JvmOverloads constructor(
    ...
    private val colorLabelActive = Utils.getColorAttrDefaultColor(context, R.attr.onShadeInactive)
    private val colorLabelInactive = Utils.getColorAttrDefaultColor(context, R.attr.onShadeInactiveVariant)
